...
O painel direito mostra metricas gerais, uma tabela de processamento por fase e duas abas, Transmissor e Receptor. Cada aba mostra os bits de cada camada, o texto recuperado, um relatorio por quadro (EDC OK ou com erro, bits corrigidos e erro duplo) e os graficos dos sinais desenhados diretamente em GTK. A separacao entre TX e RX fica explicita, atendendo ao enunciado.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\linewidth]{interface_gtk.png}
  \caption{Interface gráfica em GTK 3: painel de configuração à esquerda, métricas no painel principal, tabela por fase e abas Transmissor/Receptor com gráficos nativos dos sinais.}
